 ...
 */
globObj.getClientHash = function(window) {
  "use strict";
  var SEP = '|',
      ua, opera, ie, document = window.document || document,
      ...
      var ua = window.navigator.userAgent || "unknown user agent";
      return ua;
      },
      ...
      pstfgrpnt = function(concat) {
      var a, b, c;
      try {
        a = fingerprint_userAgent();
      } catch (e) {
        a = '';
      }
      try {
      ...
      if (concat) {
        return stringToMD5(a + b + c);
      }

      return new Array(a, b, c);
      };

  return pstfgrpnt(true);
};